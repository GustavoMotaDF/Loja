 ...
 * @author gustavo
 */
@WebServlet(name = "Mestre", urlPatterns = {"/Mestre"})
public class Mestre extends HttpServlet {
        ...
        if (login == null || login.isEmpty()) {
            ...
            req.getRequestDispatcher("index.jsp").forward(req, resp);
             ...
             try{
                ...
                req.setAttribute("login1" ,usuariobo.getPermissao3(login));
                req.getRequestDispatcher("Paginas/mestre.jsp").forward(req, resp);
