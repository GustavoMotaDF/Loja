                ...
                <div class="col-md-7">
                    ...
                    <h1> ${mensagemErro}
                        ...
                        <%
                            ...
                            File pdf = new File(request.getRealPath("/Paginas/Aprendiz/Aulas/PDF"));
                        ...
                        %>
                        <%
                            File video = new File(request.getRealPath("/Paginas/Aprendiz/Aulas/Videos"));
                                    ...
                                    <div class="col-md-6">
                                        <div class="card align-items-center" style="width: 19rem;">
                                            <video controls style="width: 18rem;">
                                                <source src="Paginas/Aprendiz/Aulas/Videos/${video}" type="video/mp4">
                            ...
                            <div class="row">
                                <table class="table table-hover">
                                    <c:forEach items="${pdf}" var="pdf"> 
                                        <tr>
                                            <th>
                                                <a href="Paginas/Aprendiz/Aulas/PDF/${pdf} " target="_blank">${pdf}</a><br>   
                                            </th>
                                        </tr>   
                                    </c:forEach> 
                                </table>                                 
