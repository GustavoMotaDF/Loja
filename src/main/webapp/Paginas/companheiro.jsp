<%-- 
    ...
    Created on : 13/04/2020, 13:27:42
    Author     : gustavo
--%>
                ...
                <div class="col-md-7">
                    ...
                    <h1> ${mensagemErro}
                        ...
                        <%
                            ...
                            File pdf = new File(request.getRealPath("/Paginas/Companheiro/Aulas/PDF"));
                        ...
                        %>
                        <%                            File video = new File(request.getRealPath("/Paginas/Companheiro/Aulas/Videos"));
                                    ...
                                    <div class="col-md-6">
                                        <div class="card align-items-center" style="width: 19rem;">
                                            <video controls style="width: 18rem;">
                                                <source src="Paginas/Companheiro/Aulas/Videos/${video}" type="video/mp4">
                            ...
                            <div class="row">
                                <table class="table table-hover">
                                    <c:forEach items="${pdf}" var="pdf"> 
                                        <tr>
                                            <th>
                                                <a href="Paginas/Companheiro/Aulas/PDF/${pdf} " target="_blank">${pdf}</a><br>   
                                            </th>
                                        </tr>   
                                    </c:forEach> 
                                </table>                                 
