<%-- 
    Document   : aprendiz
    Created on : 28/04/2020, 20:00:43
    Author     : gustavo
--%>

<div class="modal fade bd-example-modal-lg1 fundo" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Enviar para Aprendiz</h5>
            ...
            <div class="modal-body">
                <div class="container">
                    ...
                    <div class="collapse" id="collapseExample">
                        <form action="${pageContext.request.contextPath}/UploadAprendizVideo" method="post"  enctype="multipart/form-data">
                            <div class="card">
                    ...
                    <div class="collapse" id="collapseExample1">
                        <form action="${pageContext.request.contextPath}/UploadAprendizPDF" method="post"  enctype="multipart/form-data">
                            <div class="card">
